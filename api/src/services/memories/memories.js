...
export class MemoriesService {
  async list(userId, { enabled, search, limit = 100, offset = 0 } = {}) {
  ...
  async listEnabledForInjection(userId) {
    return withUser(userId, async (client) => {
  ...
  async create(userId, { title, content, enabled }) {
  ...
  async patch(userId, id, { title, content, enabled }) {
    return withUser(userId, async (client) => {
