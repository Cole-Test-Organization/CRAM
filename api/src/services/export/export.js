...
export class ExportService {
   ...
   */
  async exportAccount(userId, slug) {
...
function renderTechnicalProfile(lines, details) {
  const facts = [];
...
function renderContactsMd(accountName, contacts) {
