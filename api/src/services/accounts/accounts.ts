...
function normalizeDomains(input: unknown): string[] | null {
...
export class AccountsService {
  async getAllSlugs(userId: number) {
  ...
  async getAll(userId: number, { status, exclude_status, needs_review, sort = 'name', order = 'asc', limit, offset = 0 }: { status?: string | null; exclude_status?: string | null; needs_review?: boolean | null; sort?: string; order?: string; limit?: number | null; offset?: number } = {}) {
    return withUser(userId, async (client) => {
  ...
  async getByDomain(userId: number, domain: string) {
    return withUser(userId, async (client) => {
  ...
  async getByDomainBrief(userId: number, domain: string) {
    return withUser(userId, async (client) => {
      const [normalized] = normalizeDomains([domain])!;
  ...
  async _findExisting(client: PoolClient, data: AccountData) {
    if (!data) return null;
  ...
  async findExisting(userId: number, data: AccountData) {
    return withUser(userId, async (client) => {
  ...
  async findOrCreate(userId: number, data: AccountData = {}, { createIfMissing = false, fuzzy = true }: { createIfMissing?: boolean; fuzzy?: boolean } = {}) {
    return withUser(userId, async (client) => {
  ...
  async _fetchWithChildren(client: PoolClient, key: string, value: string | number) {
    const row = (await client.query(
  ...
  async create(userId: number, data: AccountData) {
    return withUser(userId, async (client) => {
  ...
  async update(userId: number, id: number, data: AccountData) {
    return withUser(userId, async (client) => {
  ...
  async patch(userId: number, id: number, data: AccountData) {
    return withUser(userId, async (client) => {
      const existing = (await client.query(
        `SELECT ${ACCOUNT_COLS} FROM accounts WHERE id = $1`,
        [id]
  ...
  async listPartners(userId: number, customerAccountId: number) {
    return withUser(userId, async (client) => {
  ...
  async addPartner(userId: number, customerAccountId: number, partnerAccountId: number) {
    return withUser(userId, async (client) => {
  ...
  async removePartner(userId: number, customerAccountId: number, partnerAccountId: number) {
    return withUser(userId, async (client) => {
      await client.query(
