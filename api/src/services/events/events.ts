...
export class EventsService {
  ...
  async list({ city, country, mode, source, after, before, has_location, search, tags, sort = 'start_date', order = 'asc', limit, offset = 0 }: { city?: string; country?: string; mode?: string; source?: string; after?: string; before?: string; has_location?: boolean; search?: string; tags?: string | string[]; sort?: string; order?: string; limit?: number | null; offset?: number } = {}) {
  ...
  async upcomingWithMatchedContacts(userId: number, { after, before, mode = 'in_person', limit = 100 }: { after?: string; before?: string; mode?: string; limit?: number } = {}) {
