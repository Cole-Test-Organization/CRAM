...
export default async function outreachRoutes(fastify, { outreachService }) {
  fastify.post('/outreach/enrich', {
    schema: {
  ...
  fastify.get('/outreach/enrich/:jobId', {
    schema: {
