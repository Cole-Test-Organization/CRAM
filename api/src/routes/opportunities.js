...
export default async function opportunityRoutes(fastify, { opportunitiesService, accountsService }) {
  ...
  fastify.get('/accounts/:accountId/opportunities', {
    schema: {
  ...
  fastify.patch('/opportunities/:id', {
    schema: {
  ...
  fastify.delete('/opportunities/:id', {
    schema: {
  ...
  fastify.post('/opportunities/:id/products/:productId', {
    schema: {
  ...
  fastify.delete('/opportunities/:id/products/:productId', {
    schema: {
