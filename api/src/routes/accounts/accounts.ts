...
export default async function accountRoutes(fastify: FastifyInstance, { accountsService }: { accountsService: AccountsService }) {
  // List all accounts
  fastify.get<{ Querystring: { status?: string; exclude_status?: string; needs_review?: boolean; sort?: string; order?: string; limit?: number; offset?: number } }>('/accounts', {
    schema: {
  ...
  fastify.get<{ Querystring: { q: string; limit?: number } }>('/accounts/search', {
    schema: {
  ...
  fastify.post<{ Body: { slug?: string; name?: string; domains?: string[] } }>('/accounts/find-existing', {
    schema: {
  ...
  fastify.post<{ Body: { slug?: string; name?: string; domains?: string[]; status?: string; create_if_missing?: boolean; fuzzy?: boolean } }>('/accounts/find-or-create', {
    schema: {
  ...
  fastify.get<{ Params: { domain: string } }>('/accounts/by-domain/:domain', {
    schema: {
  ...
  // Get account by ID
  fastify.get<{ Params: { id: number } }>('/accounts/:id', {
    schema: {
  ...
  // Create account
  fastify.post<{ Body: { slug: string; name: string; status?: string; last_contact?: string; relationship_summary?: string; active_deals?: string; domains?: string[]; favorite?: boolean; needs_review?: boolean } }>('/accounts', {
    schema: {
  ...
  // Full update
  fastify.put<{ Params: { id: number }; Body: { slug: string; name: string; status?: string; last_contact?: string; relationship_summary?: string; active_deals?: string; domains?: string[]; favorite?: boolean } }>('/accounts/:id', {
    schema: {
  ...
  fastify.patch<{ Params: { id: number }; Body: { slug?: string; name?: string; status?: string; last_contact?: string; relationship_summary?: string; active_deals?: string; domains?: string[]; favorite?: boolean; needs_review?: boolean } }>('/accounts/:id', {
    schema: {
  ...
  fastify.get<{ Params: { id: number } }>('/accounts/:id/partners', {
    schema: {
  ...
  fastify.post<{ Params: { id: number; partnerId: number } }>('/accounts/:id/partners/:partnerId', {
    schema: {
  ...
  fastify.delete<{ Params: { id: number; partnerId: number } }>('/accounts/:id/partners/:partnerId', {
    schema: {
  ...
  // Delete
  fastify.delete<{ Params: { id: number } }>('/accounts/:id', {
    schema: {
