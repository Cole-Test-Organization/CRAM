...
export default async function accountDetailsRoutes(fastify: FastifyInstance, { accountDetailsService, vendorHeatmapService }: { accountDetailsService: AccountDetailsService; vendorHeatmapService: VendorHeatmapService }) {
  fastify.get<{ Params: { accountId: number } }>('/accounts/:accountId/details', {
    schema: {
  ...
  fastify.get<{ Params: { accountId: number } }>('/accounts/:accountId/vendor-heatmap', {
    schema: {
  ...
  fastify.patch<{ Params: { accountId: number }; Body: Record<string, any> }>('/accounts/:accountId/details', {
    schema: {
