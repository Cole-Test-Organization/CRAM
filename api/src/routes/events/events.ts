...
export default async function eventRoutes(fastify: FastifyInstance, { eventsService }: { eventsService: EventsService }) {
  fastify.get<{ Querystring: { city?: string; country?: string; mode?: string; source?: string; after?: string; before?: string; has_location?: boolean; search?: string; tags?: string; sort?: string; order?: string; limit?: number; offset?: number } }>('/events', {
    schema: {
  ...
  fastify.get<{ Querystring: { mode?: string; after?: string; before?: string; limit?: number } }>('/events/upcoming/with-contacts', {
    schema: {
  ...
  fastify.post<{ Body: { source: string; source_id: string; title: string; summary?: string | null; start_date?: string | null; end_date?: string | null; mode?: string | null; location_raw?: string | null; city?: string | null; state?: string | null; country?: string | null; venue?: string | null; url?: string | null; tags?: string[] } }>('/events', {
    schema: {
