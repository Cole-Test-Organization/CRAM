...
export default async function threadRoutes(fastify, { threadsService }) {
  ...
  fastify.patch('/threads/:id/tasks/:taskId', {
    schema: {
  ...
  fastify.delete('/threads/:id/tasks/:taskId', {
    schema: {
  ...
  fastify.post('/threads/:id/contacts', {
    schema: {
  ...
  fastify.delete('/threads/:id/contacts/:contactId', {
    schema: {
