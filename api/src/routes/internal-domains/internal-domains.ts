...
export default async function internalDomainRoutes(fastify: FastifyInstance, { internalDomainsService }: { internalDomainsService: InternalDomainsService }) {
  ...
  fastify.post<{ Body: { domain: string } }>('/internal-domains', {
    schema: {
